...
//  Navigation
//
//  Created by Татьяна Новичихина on 18.11.2022.
//
...
class PostTableViewCell: UITableViewCell {
    ...
    func setupCell(_ postVk: PostVK) {
        ...
        guard let sourceImage = UIImage(named: postVk.image) else { return }
        imageProcessor.processImage(sourceImage: sourceImage, filter: .crystallize(radius: 50)) { image in postImage.image = image
        }
